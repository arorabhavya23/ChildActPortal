...
<html>
    <head>
        ...
        <title>FAQ| childAct portal of India</title>
        <style>
...
ResultSet rs=st.executeQuery("SELECT Act_ID FROM acts");
                ...
                while(rs.next()){
                    ...
                    // for(int j=1;j<=6;j++){
                        ...
                        out.print("<li><a type='submit' onclick='navForm(" +/* rs.getInt(1) */ k+ ")'href='#'>Act "+k+"</a></li>");
                        k++;
                    // }
                     out.print("</ul></div>");
                 }
    ...
    <!-- <button type="button" style="background-color:#337ab7;"class="btn btn-danger">Search</button>-->
        ...
        <div class="container-fluid">
            <center style="padding-top:5%;"><h1>FAQ</h1>
       ...
       while(rs.next()){
           out.print(rs.getString(1) + "&nbsp&nbsp&nbsp&nbsp&nbsp");
       out.print(rs.getString(2) + "<br>");
       out.print(rs.getString(3) + "<br><br><br>");
                                   }
                                   }
                                   catch(Exception e) {
