<%-- 
    Document   : stakeholderModify
    Created on : 19 Feb, 2017, 11:20:08 PM
    Author     : gate
--%>
...
actname = rs.getString(2);
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapse1">Delete StakeHolder</a>
      </h4>
    </div>
    <div id="collapse1" class="panel-collapse collapse">
        <div class="panel-body"><div class="form-group">
  <label for="sel1">Select stakeHolder to Delete:</label>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapse2">Add StakeHolder</a>
      </h4>
    </div>
    <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body"><label for="usr">Act Description:</label>
  <textarea class="form-control" id="usr"></textarea></div>
