    ...
    <!-- <button type="button" style="background-color:#337ab7;"class="btn btn-danger">Search</button>-->
        ...
        <div id="sidebar-wrapper" data-spy="affix" data-offset-top="1" style="z-index:-10;overflow:hidden;">
            <ul class="sidebar-nav">
                <img src="images/nature-forest-industry-rails.jpg">
            </ul>
        </div>
        <!-- /#sidebar-wrapper -->
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8">
                        <div style="padding-top:5%;" class="text-left">
                        
       <br><br>
        <%
       int actNum = 1;
       String n = request.getParameter("actId");
       String m = request.getParameter("navActId");
       
       if(n != null) {
           actNum = Integer.parseInt(n);
       }
       else if(m != null) {
           actNum = Integer.parseInt(m);
       }
       rs=st.executeQuery("SELECT * FROM acts where Act_ID = " + actNum);
       if(rs.next()){
           actname = rs.getString(2);
           out.print("<center><h1>" + actname + "</h1></center>");
       out.print(rs.getString(3));
       out.print("<br><br><br><br><center>Download from here<a href= pdf/" + rs.getString(6) + " download=" + rs.getString(6) + "> " + rs.getString(2) + "</a></center>");
                                   }
                                   }
                                   catch(Exception e) {
                                       out.println("The error occured " + e);
                                   }

       %>
       <!-- act id from body :
       //  //request.getParameter("actId")%>--><br>
